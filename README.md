...
from https://github.com/yamagenii/kubernetes-native-testbed/settings/hooks/new

```
* Payload URL: https://tekton.104.198.120.237.nip.io/event-listener
...
| ---- | -------- | -------- | -------- |
| Image Registry | https://harbor.104.198.120.237.nip.io | admin | admin |
| CI | https://tekton.104.198.120.237.nip.io | NO | NO |
| CD | https://argocd.104.198.120.237.nip.io | NO | NO |
| Object Storage | https://minio.104.198.120.237.nip.io | minio | miniosecret |
| Block/Shared Storage | https://rook.104.198.120.237.nip.io/ | admin | 'kubectl -n rook-ceph get secret rook-ceph-dashboard-password -o jsonpath="{['data']['password']}" | base64 -d' |
| Dashboard | https://dashboard.104.198.120.237.nip.io/ | NO | NO |
| Monitoring | https://grafana.104.198.120.237.nip.io/ | admin | admin |
| Monitoring | https://prometheus.104.198.120.237.nip.io/ | NO | NO |
| Monitoring | https://weave-scope.104.198.120.237.nip.io | NO | NO |
| Alerting | https://alertmanager.104.198.120.237.nip.io/ | NO | NO |
| Search - ES | https://testbed.104.198.120.237.nip.io/search/es | elastic | 'kubectl -n search get secret search-db-es-elastic-user -o jsonpath="{.data.elastic}" | base64 -d' |
| Search - Kibana | https://testbed.104.198.120.237.nip.io/search/kibana | elastic | 'kubectl -n search get secret search-db-es-elastic-user -o jsonpath="{.data.elastic}" | base64 -d' |
| Point - DB | https://yugabyte.104.198.120.237.nip.io/point/master/ | NO | NO |
| Point - DB | https://yugabyte.104.198.120.237.nip.io/point/tserver/ | NO | NO |

* Microservice

| Kind | Endpoint | Username | Password |
| ---- | -------- | -------- | -------- |
| Admin | https://testbed.104.198.120.237.nip.io/admin/ | NO | NO |
...
https://testbed.104.198.120.237.nip.io/admin/index.html
  or
http://localhost:8080/
```
